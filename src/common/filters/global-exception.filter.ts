...
import {
  AppErrorCode,
  ERROR_DEFINITIONS,
} from '#src/common/exceptions/error-definitions.js';
import { ValidationError } from '#src/common/exceptions/validation.exception.js';
import type { ValidationIssue } from '#src/common/types/validation-issue.type.js';
import { isI18nKeyLike, stripQuery } from '#src/common/utils/shared.utils.js';
import {
  Catch,
  HttpException,
  Inject,
